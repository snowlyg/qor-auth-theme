module github.com/snowlyg/qor-auth-theme
...
require (
	...
	github.com/qor/admin v0.0.0-20200226160302-2455d82c6e00 // indirect
	...
	github.com/snowlyg/qor-registerviews v0.0.0-20200228034429-c4067bf21caa
